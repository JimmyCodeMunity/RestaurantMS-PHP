...
if(isset($_POST['submit'])){
	...
	if(mysqli_num_rows($result) > 0){
		...
		if($password != $cpass){
			...
			$insert = "INSERT INTO userdata(firstname,lastname,phone,email,password)VALUES('$fname','$lname','$phone','$email','$password')";
      ...
      ?>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="fname" required class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend"></span>
                        <input type="text" name="lname" required class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend"></span>
                        <input type="text" name="phone" required class="form-control" id="yourUsername" required>
