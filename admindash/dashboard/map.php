                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required placeholder="enter Food name" name="servname" value="">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <select name="category" class="form-control rounded-3" id="floatingInput" required>
                          <option for = "service" value="">---choose Category---</option>
                          <?php
                          ...
                          while($row = $sel->fetch_assoc()){
                            $cn++;
                            ?>
                            <option for="service"><?php echo $row['cat_name']?></option>
                            <?php } ?>
                        </select>
                      </div>
                    </div>
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12" id="foods">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Available Foods</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <?php
                        $i = 0;
        if($stmt = $conn->query("SELECT * FROM menu")){
          while ($row = $stmt->fetch_assoc()) {
           ...
           <tr style="background-color:white; font-size: 14px;">
                 ...
                 <td><img style="border-radius: 50%;" src="images/<?=$row['food_photo'] ?>"width="50px" height="50px" ></td>
