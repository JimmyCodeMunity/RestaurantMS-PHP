...
if(isset($_POST['update'])){
  ...
  $update_data = "UPDATE orders SET customername = '$cust',phone='$phone',amount='$amt',price = '$fprice',category='$foodcat',paid='$paid' WHERE id='$id'";
                  ...
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Company" disabled value="UrbanEatery">
                      </div>
                    </div>
                    <br>
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" required placeholder="" name="price" value="<?php echo $row['price']?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required placeholder="" name="customer" value="<?php echo $row['customername']?>">
                      </div>
                    </div>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>Phone</label>
                        <input type="number" class="form-control" required placeholder="" name="phone" value="<?php echo $row['phone']?>">
                      </div>
                    </div>
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>Paid</label>
                        <input type="number" class="form-control" required placeholder="" name="paid" value="<?php echo $row['paid']?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        <label>Amount</label>
                        <input type="number" class="form-control" required placeholder="" name="amount" value="<?php echo $row['amount']?>">
                      </div>
                    </div>
