...
$admin = "SELECT count(*) FROM userdata WHERE role = 1 ";
$res = mysqli_query($conn,$admin);
$regist = "SELECT count(*) FROM userdata";
$signups = mysqli_query($conn,$regist);
$books = "SELECT count(*) FROM menu";
$servcount = mysqli_query($conn,$books);
...
while($row = mysqli_fetch_array($catnum)){
  $bookings = $row['count(*)'];
}
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Welcome <span><?php echo $_SESSION['admin_name']?></span></a>
          </div>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item btn-rotate dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="complains.php">Complains</a>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php echo $_SESSION['admin_name']?><p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card card-stats">
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php echo $bookings ?><p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="card-footer ">
                ...
                <div class="stats">
                  ...
                  <a class="" href="orders.php">View</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php echo $servcounter?><p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php echo $regcounter?><p>
                    </div>
                  </div>
                </div>
              </div>
