...
if(isset($_POST['update'])){
  ...
  $update_data = "UPDATE userdata SET firstname='$fname',lastname = '$lname',phone='$phone',email='$email' WHERE id='$id'";
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required placeholder="" name="firstname" value="<?php echo $row['firstname']?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required placeholder="" name="lastname" value="<?php echo $row['lastname']?>">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 px-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required placeholder="" name="phone" value="<?php echo $row['phone']?>">
                      </div>
                    </div>
